...
void Rigidbody::Update() {
	//Rigidbody is keeping track of the rotation FROM the sprite
...
void Rigidbody::Render(Vector3 c) {
	...
	//glRotatef(*rot, 0, 0, 1); //removed b/c now we're rotating the points ourselves
...
///calculates whether 2 rigid bodies are colliding
///Episode 5, around 1:13:00
//we're going to use the Dot product of each vertex onto the other rect's axes's (one by one)
